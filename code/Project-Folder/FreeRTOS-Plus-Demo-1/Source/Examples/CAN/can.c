...
{
	xTaskCreate( 	prvCANWriteTask,						/* The task that uses the CAN in SPI mode. */
					( const int8_t * const ) "CANWrt", /* Text name assigned to the task.  */
					configCAN_TASK_STACK_SIZE,	/* The size of the stack allocated to the task. */
					NULL,									/* The parameter is not used, so NULL is passed. */
					configCAN_TASK_PRIORITY +3,	/* The priority allocated to the task. */
