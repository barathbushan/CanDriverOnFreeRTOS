...
{																				\
	...
	{ ( const int8_t * const ) "/CAN2/", eCAN_TYPE, ( void * ) LPC_CAN2 },		\
    { ( const int8_t * const ) "/CAN1/", eCAN_TYPE, ( void * ) LPC_CAN1 }		\
}
...
#define boardCONFIGURE_I2C_PINS( cPeripheralNumber, xPinConfig )					\
	...
	/*******************************************************************************
 * Configure port CAN port pins to be correct for the wiring of the
 * LPCXpresso base board.
 ******************************************************************************/
#define boardCONFIGURE_CAN_PINS( cPeripheralNumber, xPinConfig )					\
	switch( ( cPeripheralNumber ) )													\
	{																				\
		case 2	:	( xPinConfig ).Funcnum = 2;										\
					( xPinConfig ).Pinnum = 4;										\
...
/*******************************************************************************
 * Set the default baud rate used by PORTS.
 ******************************************************************************/
#define boardDEFAULT_UART_BAUD		115200
#define boardDEFAULT_CAN_BAUD		125000
