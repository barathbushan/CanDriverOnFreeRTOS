...
#ifndef FREERTOS_IO_CAN_H
#define FREERTOS_IO_CAN_H
...
portBASE_TYPE FreeRTOS_CAN_ioctl( Peripheral_Descriptor_t const pxPeripheral, uint32_t ulRequest, void *pvValue );

#endif /* FREERTOS_IO_CAN_H */
